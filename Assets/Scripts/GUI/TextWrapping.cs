...
public class TextWrapping : MonoBehaviour {

    public var textObject : TextMesh;
     
    private var maxLineChars : int = 35; //maximum number of characters per line...experiment with different values to make it work
